...
import com.kazee.waktoo.common.constant.AppConstants.IMAGE_DIRECTORY_NAME
...
object Fungsiku {
    ...
    fun showToast(stringRes: Int) {
        showToast(BaseApp.context!!.getString(stringRes))
    }
    ...
    fun showToast(message: String, toastLength: Int = Toast.LENGTH_SHORT) {
        Toast.makeText(BaseApp.context, message, toastLength).show()
    }
